// From 'react-hook-geolocation' (https://github.com/bence-toth/react-hook-geolocation)
...
const useGeolocation = ({ enableHighAccuracy, maximumAge, timeout }: useGeolocation, callback) => {
